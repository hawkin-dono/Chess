...
def generate_pseudo_legal_promotion_queen_non_capture(board: Board, from_mask = BB_ALL, to_mask = BB_ALL):
    ...
    # Tạo các nước đi phong hậu ăn quân đối phương
    ...
    # Tạo các nước đi phong hậu không ăn quân đối phương
...
def generate_legal_promotion_queen_non_capture(board: Board, from_mask = BB_ALL, to_mask = BB_ALL):
    ...
    if king_mask:
        ...
        if checkers:
            ...
            for move in generate_pseudo_legal_promotion_queen_non_capture(board, from_mask, to_mask):
